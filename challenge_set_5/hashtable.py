...
class HashTable(object):
    ...
    def values(self):
        ...
        TODO: Running time: O(n*m) Why and under what conditions?"""
        all_values = []
        for bucket in self.buckets:
            for key, value in bucket.items():
    ...
    def length(self):
        ...
        #Create attribute to save length in class
    ...
    def contains(self, key):
        ...
        key_item = self.buckets[index].find(lambda item: item[0] == key)
    ...
    def set(self, key, value):
        ...
        Since data is stored as a tuple and that data is immutable, we need to delete the node and append a new node
        TODO: Running time: O(???) Why and under what conditions?"""
        # index = self._bucket_index(key)
